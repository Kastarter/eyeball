...
import type { WhatsAppMessage } from "../../../../mocks/packages/mocks-messaging/dist/index.js";
import {
  hasMocksCheckout,
  loadMocksModule,
  mocksSuiteTitle,
...
let createWhatsAppBusinessMock: MessagingMocksModule["createWhatsAppBusinessMock"];
...
describe.skipIf(!mocksAvailable)(
  mocksSuiteTitle("WhatsApp Business messaging adapter", mocksAvailable),
  () => {
    beforeAll(async () => {
      ...
      ({ createWhatsAppBusinessMock } = mocks);
