...
<Note>
  Claude Code and Cursor manage initialize and session headers automatically. Async tools stay hidden unless the host negotiates Eyeball's experimental Tasks opt-in.
</Note>
