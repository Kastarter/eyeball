...
Self-hosted deployments bring their own provider OAuth apps and store tokens in the encrypted local vault instead — see [Bring your own OAuth](/self-hosting/byo-oauth).
