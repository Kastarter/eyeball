...
- Credential env vars use `EYEBALL_CRED_<TOOLKIT>_*`; API-key maps use `EYEBALL_API_KEYS`.
...
- Hosted OAuth vault, billing, and real-provider certification are not complete.
...
- Activepieces compatibility remains unvalidated outside its engine.
